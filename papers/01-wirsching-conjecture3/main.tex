...
majorant bounds the discarded modes by $2.80\times10^{-43}$), locates a candidate maximum at
...
For the value of $\Lambda_l$: write $\tau_l := -\log x_l^+$, so $t=x_l^+$ corresponds to $\tau=\tau_l$
