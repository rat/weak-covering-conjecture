...
the $m=0$ term cancels, four modes suffice, and the majorant $|\hat H(m)| \le A q^m
m^{-1/2}(\log(\alpha m+1)+C)$, with $\alpha = 2\pi/c$, $q = e^{-\pi\alpha/2}$, $A =
c^{-1}\sqrt{3\pi/\alpha}$ and $C = \tfrac32+\alpha^{-1}+\tfrac12\sqrt{1+\alpha^{-2}}$, gives
