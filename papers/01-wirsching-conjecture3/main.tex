...
\]
(ball radius $<10^{-70}$), matching the floating-point value above to 19 digits. The majorant
\eqref{eq:Hmajorant} gives
$\sum_{m>4}|\hat H(m)| \le 9.41\times10^{-20}$, so the discarded modes move the four-mode sum by
less than $3.8\times10^{-19}$, giving $H(0)-H(\log\tfrac32)\in[-0.0003771902809439861948,
-0.0003771902809439854348]$; this route alone certifies the stated interval for
$H(0)-H(\log(3/2))$.
