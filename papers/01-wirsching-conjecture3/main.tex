...
Since $x_l^+/x_l = 1+3^{-(l+1)}/x_l \to 1$ (as $x_l\sim l\cdot3^{-l}$) and $\varphi_0'/\varphi_0$
is, from its explicit form, continuous and slowly varying near $x_l$, (7.13) transfers from $x_l$
to $x_l^+$ with an $o(1)$ correction; substituting and using his equation~(7.13),
