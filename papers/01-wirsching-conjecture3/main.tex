...
\begin{remark}
Numerically, $E$ is also strictly decreasing and satisfies $E(N)\le4.18\,N^{-1/2}$ throughout
$19\le N\le5000$ (checked directly in the accompanying repository); neither fact, nor $E(19)<1$
itself, is used anywhere in this paper, where only $E(N)\to0$ as $N\to\infty$ is needed.
\end{remark}
...
happens to fix. That phase sits close to the smallest of the two values of $H$ certified in
