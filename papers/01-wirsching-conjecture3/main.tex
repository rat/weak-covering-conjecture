...
\]
Berg and Kr\"uppel display the second of these with $+2\beta$ in place of $-2\beta$; differentiating
$f$ twice gives $-2\beta$. Their Proposition~9.1 is unaffected, the term being of lower order there
than $2\beta\log p$, but the exact expression used here is not.
